...
const Links = () => {
  return (
    <div className="flex items-center justify-between rounded-lg bg-gray-800 px-4 py-6 transition-all hover:bg-gray-700/50">
      <div className="">
        <div className="flex items-center gap-x-2 text-gray-300">
          <Link href="https://slash.ly/github">
            <h4 className="text-blue-500">slash.ly/github</h4>
          </Link>
          <div className="cursor-pointer rounded-full bg-gray-700 p-2 transition-all hover:scale-110 hover:bg-gray-600 hover:text-blue-200">
          ...
          >
            ...
            <p className="text-xs">2 clicks</p>
          </Link>
        </div>
        <p className="text-sm text-gray-300">https://github.com/slash-ly</p>
      </div>
